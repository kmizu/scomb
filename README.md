...
```scala
libraryDependencies += "com.github.kmizu" %% "scomb" % "0.3"
```
...
- [CalculatorSpec](https://github.com/kmizu/scomb/blob/releases/0.3/src/test/scala/com/github/kmizu/scomb/CalculatorSpec.scala)
  - Arithmetic Expression Parser
- [JsonSpec](https://github.com/kmizu/scomb/blob/releases/0.3/src/test/scala/com/github/kmizu/scomb/JsonSpec.scala)
  - JSON Parser
- [RegularExpressionSpec](https://github.com/kmizu/scomb/blob/releases/0.3/src/test/scala/com/github/kmizu/scomb/RegularExpressionSpec.scala)
